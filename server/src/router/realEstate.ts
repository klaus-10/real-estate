...
import { getAllRealEstatesLocationFromBoundingBox } from "db/realEstate";
  ...
  export default (router: express.Router) => {
    ...
    router.post("/real-estate/locationsByBoundingBox", getAllRealEstatesLocationFromBoundingBoxList);
    router.post("/real-estate/locationsByName", getAllRealEstatesLocationByLocationNameList);
